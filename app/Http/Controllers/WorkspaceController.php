...
class WorkspaceController extends Controller
{
    ...
    public function search(Request $request): JsonResponse
    {
        ...
        if(ENV('MULTIMARCA') == true){
            $config->logo = 'https://statics-testing.sfo2.cdn.digitaloceanspaces.com/images/wrkspc-40-wrkspc-35-logo-cursalab-2022-1-3-20230601193902-j6kjcrhock0inws-20230602170501-alIlkd31SSNTnIm.png';
