...
FROM 505992365906.dkr.ecr.us-east-1.amazonaws.com/composer:2.0.15 as composer_base
...
FROM 505992365906.dkr.ecr.us-east-1.amazonaws.com/php:2.0.15 as cli
...
# We need a stage which contains FPM to actually run and process requests to our PHP application.
FROM 505992365906.dkr.ecr.us-east-1.amazonaws.com/phpfpm:2.0.15 as fpm_server
