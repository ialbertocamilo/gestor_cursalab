...
class TestSeeder extends Seeder
{
    ...
    public function insertCriteria() {
        ...
        $criteria = [
            ...
            ['code' => 'date_start', 'name' => 'Date_Start','required' =>1,'show_in_segmentation' =>1,'is_default' => 1, 'field_id' => $default_type->id],
            ['code' => 'seniority_date', 'name' => 'Seniority_date','required' =>1,'show_in_segmentation' =>0,'is_default' => 1, 'field_id' => $default_type->id],
            ['code' => 'birthday_date', 'name' => 'Birthday_date','required' =>1,'show_in_segmentation' =>0,'is_default' => 1, 'field_id' => $default_type->id],
