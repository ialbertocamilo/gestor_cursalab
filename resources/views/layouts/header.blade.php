...
{{--      <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.13.0/css/all.min.css">--}}
    ...
    <!-- theme stylesheet-->
    <link rel="stylesheet" href="{{ asset('css/style.default.css?v=1.1342' . date('Y-W-d') ) }}" id="theme-stylesheet">
    <!-- Custom stylesheet - for your changes-->
    <link rel="stylesheet" href="{{ asset('css/custom.css?v=2.2392-'.date('Y-W-m-d')) }}">
    <link rel="stylesheet" href="{{ asset('css/app.css?v=1.1392-'.date('Y-W-m-d-H')) }}">
    <!-- Favicon-->
