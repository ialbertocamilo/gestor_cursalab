<template>
    <div>
        <v-row class="pl-4 pr-4 pt-4 pb-3">
            <v-col cols="12">
                En esta lista encontrarás todos los reportes generados de este
                mes, listos para descargar.
                <v-btn
                    v-if="isSuperUser"
                    color="primary"
                            ...
                            <tr v-for="item in reports" :key="item.id">
                                ...
                                <td class="text-center">
                                    ...
                                    <v-icon
                                        ...
                                        "
                                        @click="
                                            showModal(item.filters_descriptions)
                                        "
                                        color="#5457E7"
                                    >
                                        mdi-filter-menu
                                ...
                                <td class="text-center">
                                    <v-icon
                                        ...
                                        "
                                        v-if="
                                            item.is_ready && item.download_url
                                        "
                                        color="#5457E7"
                                    >
                                        mdi-download
        ...
        <ReportFiltersModal
            ...
            @cancel="filtersModalIsOpen = false"
        ></ReportFiltersModal>
    </div>
</template>
        ...
        async restartQueue() {
            ...
            try {
                ...
                if (response.data.started) {
                    ...
                    this.notifyUser(
                        "No hay reportes pendientes para reiniciar"
                    );
                }
