            ...
            <v-card tile elevation="0" class="--my-3">
                <v-card-text class="pb-0">
                    ...
                    >
                        ...
                        <v-tab href="#stats" @click="getBlockStats"
                                                ...
                                                <td colspan="3" align="center" class="word-break">
                                                    <div class="d-flex justify-content-center align-content-center">
                                                        ...
                                                        <v-icon v-if="resource.status.code == 'in-progress'"
                                                                ...
                                                                @click="updateBlockUrlStart" v-text="'mdi-refresh'"/>
                                                    </div>
                        ...
                        >
                            <v-card flat>
                                <v-row>
                                    ...
                                    <v-col cols="6">
                                        <GeneralGraphic
                                            :graphic_data="graphics.topGuestDurationInBlock"
                                            @refreshCache=""
                                        />
                                    </v-col>
                                ...
                                <v-row justify="center">
                                    <!--                                    <v-col cols="6">-->
                                    <!--                                        <GeneralGraphic-->
                                    <!--                                            :graphic_data="graphics.averageTimeInBlock"-->
                                    <!--                                            @refreshCache=""-->
                                    <!--                                        />-->
                                    <!--                                    </v-col>-->
                                    <v-col cols="6">
...
export default {
    components: {DefaultLogoImage, BlockDeleteModal, GeneralGraphic},
    props: {
        options: {
            type: Object,
            required: true
    ...
    data() {
        return {
            ...
            graphics: {
                ...
                topGuestDurationInBlock: {
                    overlay: true,
                    ref: 'topGuestDurationInBlock',
                    last_update: null,
                    series: [{
        ...
        getBlockStats() {
            ...
            vue.$http.get(url)
                .then(({data}) => {
                    ...
                    let averageTimeInBlock = _data.stats['averageTimeInBlock']
                    let attendeesPerCallAssistance = _data.stats['attendeesPerCallAssistance']
                    let topGuestDurationInBlock = _data.stats['topGuestDurationInBlock']
                    ...
                    vue.setDataChart('averageTimeInBlock', averageTimeInBlock)
                    ...
                    vue.setDataChart('topGuestDurationInBlock', topGuestDurationInBlock)
