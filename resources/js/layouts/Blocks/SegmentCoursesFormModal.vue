    ...
    >
        <template v-slot:content>
            <v-form ref="segmentForm" class="---mb-6">
                    ...
                    <v-tab-item class="first-tab" v-if="show_criteria_segmentation">
                        ...
                        <div
                            ...
                            <v-btn
                                class="--add-button "
                                color="primary"
                                @click="modalModuleOptions.open = true"
                            >
                                <v-icon size="14"
                                        class="mr-2"
                                        v-text="'mdi-plus'"/>
                ...
                <SegmentModuleModal
                    :criteria="criteria"
                    :options="modalModuleOptions"
                    :ref="modalModuleOptions.ref"
                    @onModulesSelected="showModulesInSegmentation($event)"
                    @onCancel="closeSegmentModuleModal()"
                />
...
<script>
import SegmentModuleModal from "./SegmentModuleModal.vue";
...
export default {
    ...
    data() {
        return {
            ...
            modalModuleOptions: {
                ref: 'SegmentModuleModal',
                open: false,
                title: 'Selecciona tus módulos',
                resource:'data',
...
.add-button-wrapper .add-button-description {
    width: 45%;
    line-height: 16px;
    margin-top: 20px;
    font-size: 12px;
