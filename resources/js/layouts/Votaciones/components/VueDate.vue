<template>
	<div>
		...
		<input :id="name" :type="type" class="text-center form-control" placeholder="Seleccione fecha" 
					 @change="emitCurrentDate">
	</div>
</template>
