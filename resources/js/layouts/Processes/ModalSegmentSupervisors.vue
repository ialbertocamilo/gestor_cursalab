<template>
    <v-form ref="segmentFormSupervisor" class="---mb-6">
...
export default {
    ...
    methods: {
        ...
        resetValidation() {
            let vue = this;
            vue.$refs.segmentFormSupervisor.resetValidation();
        },
        ...
        confirmModal() {
            ...
            const validateForm = vue.validateForm("segmentFormSupervisor");
