...
export default {
    ...
    methods: {
        ...
        /**
         * Set ticket status to "Contactado"
         */
        async markTicketAsContacted() {
            if (this.resource.estado === 'Solucionado') return;

            let base = `${this.options.base_endpoint}`
            let url = `${base}/${this.resource.id}/update`;
