    ...
    data() {
        return {
            dataTable: {
                ...
                ref: 'AyudaTable',
                headers: [
                    {text: "Orden", value: "position",  align: 'center', model: "Post", sortable: false},
                    {text: "Nombre", value: "title", align: 'left', sortable: false},
                    {text: "Detalle", value: "check_text_area", align: 'center', sortable: false},
