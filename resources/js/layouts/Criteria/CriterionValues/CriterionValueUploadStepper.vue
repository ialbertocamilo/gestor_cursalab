    ...
    <v-dialog v-model="value" :width="widthDialog"  @click:outside="closeModal">
        <v-card elevation="0">
            <v-card-title class="default-dialog-title">
                Subida masiva de valores de criterio
                <v-spacer/>
                        ...
                        <v-stepper-content step="1" style="padding-bottom: 0 !important;">
                            <v-card class="mb-5" elevation="0">
                                    ...
                                    <v-row>
                                        <v-col cols="12" md="12" lg="12">
                                            <v-alert border="top" type="info" elevation="0" outlined>
                                                <li class="m-0">
                                                    Descarga la plantilla para rellenarla con los datos que deseas subir a la
                                                    plataforma.
                                                </li>
                                            </v-alert>
                                        </v-col>
                                ...
                                <v-row>
                                    ...
                                    <v-col cols="12" md="12" lg="12">
                                        <!-- <v-btn text @click="e1=e1--"> Atras</v-btn> -->
                                                ...
                                                <v-col cols-="12" md="12" lg="12"
                                                    ...
                                                    <div class="messages_stepper_upload">
                                                        <ul style="text-align: left;">
                                                            <li class="m-0">
                                                                Los datos con observaciones no se subieron a la plataforma.
                                                            </li>
                                                            <li class="m-0">
                                                                Puedes corregir o actualizar los datos del archivo con observaciones y
...
export default {
    ...
    methods: {
        ...
        descargarErrores() {
            let vue = this
            let headers = ["CRITERIO","MENSAJE"];
            let values = ["criterio", "msg"];
